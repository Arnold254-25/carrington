...
{currentState === 'Login' ? '' : <input type="number" className='w-full px-3 py-2 border border-gray-800 rounded' placeholder='Phone' required />}
<input type="password" className='w-full px-3 py-2 border border-gray-800 rounded' placeholder='Password' required />

<div className='w-full flex justify-between text-sm mt-[-8px] ml-3'>
...

  {
    ...
    : <p onClick={()=>setCurrentState('Login')} className='cursor-pointer mr-3'>Login</p>
  }
